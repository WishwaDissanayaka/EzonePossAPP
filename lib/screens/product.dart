                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  Text(
                                    'Available: ${((item['product_variations']?.isNotEmpty ?? false) &&
                                                            (item['product_variations'][0]['variations']?.isNotEmpty ?? false) &&
                                                            (item['product_variations'][0]['variations'][0]['variation_location_details']?.isNotEmpty ?? false))
                                                        ? double.parse(item['product_variations'][0]['variations'][0]['variation_location_details'][0]['qty_available']).toStringAsFixed(0)
                                                        : 'N/A'}',
                                    style: TextStyle(
                                  ...
                                  Text(
                                    'Price: ${((item['product_variations']?.isNotEmpty ?? false) &&
                                                            (item['product_variations'][0]['variations']?.isNotEmpty ?? false) &&
                                                            (item['product_variations'][0]['variations']?.isNotEmpty ?? false))
                                                        ? double.parse(item['product_variations'][0]['variations'][0]['sell_price_inc_tax']).toStringAsFixed(0)
                                                        : 'N/A'}',
                                    style: TextStyle(
                                      color: Colors.grey[600],
                                    ),
